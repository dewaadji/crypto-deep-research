...
summary_system_prompt = """Based on the research and findings, draw a simple conclusion that still covers all the values obtained, well-structured to overall findings:
...
Please provide a comprehensive conclusion to answer the question with:
